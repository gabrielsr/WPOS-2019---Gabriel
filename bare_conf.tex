...
In previous work we have proposed Goalp, an approach for automatic goal-oriented deployment planning in heterogeneous environments. In Goalp, software components should be annotated with information about the (a) goals that the component can achieve; (b) the required runtime resources; (c) components requirements in terms of sub-goal or tasks and (d) level of service quality that the component could provide as a function of available resources.  Goalp we introduced the idea of goal-oriented deployment planning. 
